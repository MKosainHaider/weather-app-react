    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-r from-blue-500 to-purple-600">
        <div className="p-10 text-center bg-white rounded-lg shadow-lg bg-opacity-90">
          <h1 className="mb-6 text-4xl font-bold text-gray-800">5-Day Weather Forecast</h1>
          <CityInput onCityChange={this.handleCityChange} />
          <WeatherList weatherData={this.state.weatherData} currentWeather={this.state.currentWeather} />
        </div>
      </div>
    );
  }
