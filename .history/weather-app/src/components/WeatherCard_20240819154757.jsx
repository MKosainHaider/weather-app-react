...
function WeatherCard({ day, isCurrent }) {
  ...
  return (
    ...
    >
      <h2 classList="mb-2 text-2xl font-bold text-gray-700">{dayName}</h2>
      <p classList="mb-4 text-sm text-gray-500">{date.toLocaleDateString()}</p>
      <p className="mb-2 text-lg text-gray-600">
        Temperature: {main.temp}°C</p>
